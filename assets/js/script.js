$(document).ready(function() {
    ...
    $("#contact-form").submit(function(event) {
        ...
        emailjs.init("6ldfLxV_oYXp9RfqE");

        emailjs.sendForm('service_g382snk', 'template_go5633p', '#contact-form')
...
var typed = new Typed(".typing-text", {
    strings: ["frontend development", "backend development", "Database Design", "Database Administration",
        "web designing", "android development", "web development", "software development"
    ],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
...
async function fetchData(type = "skills") {
    ...
    type === "skills" ?
        ...
        response = await fetch("./projects/myprojects.json")
      ...
      <div class="content">
        ...
        <div class="desc">
          ...
          <div class="btns">
            ...
            <a href="${project.link}" class="btn" target="_blank">Code <i class="fas fa-code"></i></a>
          </div>
        </div>
      </div>
    </div>`
...
const srtop = ScrollReveal({
    ...
    distance: '80px',
    duration: 1000,
    reset: false  // Avoid unnecessary re-animations
});
...
if (window.innerWidth > 768) {  
    ...
    srtop.reveal('.home .twitter', { interval: 300 });
